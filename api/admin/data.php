...
<html lang="fr">
  <head>
    ...
    <title>Data - Programme Alfia</title>
    <!-- Google font-->
  ...
  <body>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="bookmark">
                    <ul>
                      <li>
                        <a href="export.php" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Icons"><i data-feather="command"></i> Exort to Excel</a></li>                        
                      </li>
                    </ul>
                  </div>
                  <!-- Bookmark Ends-->
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2022 © MoonGraphe.</p>
              </div>
            </div>
          </div>
        </footer>
    ...
    <script src="assets/js/datatable/datatable-extension/dataTablesautoFill.min.js"></script>
